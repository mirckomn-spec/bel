        ...
        >
          {activeSection === "dashboard" ? (
            <>
              ...
              <article className="relative mt-4 overflow-hidden rounded-3xl border-2 border-[#F48FB1] bg-gradient-to-br from-[#FFFFFF] via-[#FDF2F5] to-[#FCE4EC] p-4 shadow-lg shadow-[#F48FB122] sm:p-6">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                <article className="rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4">
                  <p className="text-sm text-[#B885A3]">Comprovantes no periodo</p>
                  <p className="text-2xl font-semibold text-[#F48FB1]">{adminProofsCount}</p>
                </article>
                <article className="rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4">
                  <p className="text-sm text-[#B885A3]">Ticket medio (R$)</p>
                  <p className="text-2xl font-semibold text-[#F48FB1]">{adminAvgTicket.toFixed(2)}</p>
                </article>
                <article className="rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4">
                  <p className="text-sm text-[#B885A3]">Estimativa comissao 35%</p>
                  <p className="text-2xl font-semibold text-[#F48FB1]">R$ {(adminTotalSold * 0.35).toFixed(2)}</p>
                </article>
              </div>
              <div className="mt-4 rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4">
                ...
                <div className="mt-3 grid gap-2">
                  {dashboardRecentEntries.length === 0 ? (
                    <p className="text-sm text-[#B885A3]">Sem comprovantes ainda.</p>
                  ) : (
              ...
              <div className="mt-5 overflow-hidden rounded-3xl border border-[#F8BBD0] bg-gradient-to-b from-[#FFF8FA] to-[#FCE4EC] p-4 shadow-xl shadow-[#F48FB140]">
                <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
                  <p className="text-sm font-medium text-[#A64D79]">Grafico em onda (R$ por trecho)</p>
                  <p className="text-xs text-[#B885A3]">{adminChartStepDays} dia(s) por ponto</p>
                </div>
                <svg
          ...
          {activeSection === "comprovantes" ? (
            <>
              <h3 className="text-2xl text-[#A64D79]">Comprovantes</h3>
              <p className="mt-2 text-sm text-[#B885A3]">
                Envio da Bel e lista de <strong className="text-[#A64D79]">todos</strong> os
              ...
              <form className="mt-6 grid gap-3" onSubmit={onSubmit}>
                ...
                <input placeholder="Produto vendido" className="rounded-xl border border-[#F8BBD0] bg-white px-4 py-2 text-sm text-[#A64D79]" value={productName} onChange={(event) => setProductName(event.target.value)} required />
                <input placeholder="Valor (R$)" className="rounded-xl border border-[#F8BBD0] bg-white px-4 py-2 text-sm text-[#A64D79]" value={saleValue} onChange={(event) => setSaleValue(event.target.value)} required />
                <input type="file" accept="image/*,video/*" className="rounded-xl border border-[#F8BBD0] bg-white px-4 py-2 text-sm text-[#A64D79]" onChange={(event) => setFile(event.target.files?.[0] ?? null)} required />
                <button
                  type="submit"
              ...
              <div className="mt-8 rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                  <label className="grid gap-1 text-sm text-[#A64D79]">
                    Filtrar por quem enviou (login)
                    <select
                      className="max-w-md rounded-xl border border-[#F8BBD0] bg-white px-3 py-2 text-sm text-[#A64D79]"
                  ...
                  <p className="text-sm text-[#B885A3]">
                    Mostrando{" "}
                    <strong className="text-[#A64D79]">{proofsSortedForAdmin.length}</strong> de{" "}
                    <strong className="text-[#A64D79]">{proofs.length}</strong> comprovante(s)
                  </p>
                </div>
              </div>
              ...
              <div className="mt-4 grid gap-3">
                {proofs.length === 0 ? (
                  <p className="text-sm text-[#B885A3]">Nenhum comprovante enviado ainda.</p>
                ) : proofsSortedForAdmin.length === 0 ? (
                  <p className="text-sm text-[#B885A3]">Nenhum comprovante para este filtro.</p>
                ) : (
                  proofsSortedForAdmin.map((proof) => {
                    ...
                    return (
                      <article
                        key={proof.id}
                        className="flex flex-col gap-3 rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4 sm:flex-row sm:items-start"
                      >
                        <div className="flex shrink-0 items-center gap-3">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="truncate text-base font-semibold text-[#A64D79]">@{who}</p>
                        ...
                        <div className="min-w-0 flex-1 border-t border-[#F48FB122] pt-3 sm:border-l sm:border-t-0 sm:pl-4 sm:pt-0">
                          <p className="text-sm text-[#A64D79]">
                            <span className="text-[#B885A3]">Produto:</span> {proof.productName}
                            {Number(proof.saleValue ?? 0) > 0
                              ? ` — R$ ${Number(proof.saleValue ?? 0).toFixed(2)}`
                              : ""}
                          </p>
                          <a
                            className="mt-2 inline-block text-sm font-medium text-[#F48FB1] underline"
          ...
          {activeSection === "tabela" ? (
            <>
              <h3 className="text-2xl text-[#A64D79]">Tabela de quem mais vendeu</h3>
              <p className="mt-2 text-sm text-[#B885A3]">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {(["d1", "d7", "d14", "d31"] as (keyof AdminRankingWindows)[]).map((key) => (
                  <button
                    ...
                    className={`min-h-9 shrink-0 rounded-full px-3 py-1.5 text-xs hover:brightness-[0.98] ${adminRankingTab === key ? "border-[#F48FB1] bg-[#F48FB1] text-white" : "border-[#F8BBD0] bg-white text-[#A64D79]"}`}
                  >
                    {ADMIN_RANKING_LABELS[key]}
                  </button>
                ))}
              </div>
              <div className="mt-3 grid gap-2 rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-3 sm:grid-cols-[1fr_auto_auto] sm:items-end">
                <label className="grid gap-1 text-xs text-[#A64D79]">
                  Premio do periodo ({ADMIN_RANKING_LABELS[adminRankingTab]})
                  <input
                    className="rounded-lg border border-[#F8BBD0] bg-white px-2 py-1 text-sm text-[#A64D79]"
                    inputMode="decimal"
                ...
                <button
                  ...
                  className="rounded-lg bg-[#F48FB1] px-3 py-2 text-xs text-white hover:brightness-95"
                >
                  Salvar premio
                </button>
                <span className="text-xs text-[#B885A3]">
                  Atual: R$ {Number(adminRankingPrizes[adminRankingTab] ?? 0).toFixed(2)}
                </span>
              </div>
              {rankingMessage ? <p className="mt-2 text-sm text-[#A64D79]">{rankingMessage}</p> : null}
              <div className="mt-3">
                <button
                  type="button"
              ...
              <div className="mt-4 overflow-hidden rounded-2xl border border-[#F8BBD0]">
                ...
                <table className="w-full border-collapse bg-white text-left">
                  <thead className="bg-[#FFFFFF]">
                    <tr>
                      <th className="px-4 py-3 text-sm text-[#A64D79]">Posicao</th>
                      ...
                      <th className="px-4 py-3 text-sm text-[#A64D79]">Editar valor tabela</th>
                    </tr>
                  </thead>
                  <tbody>
                    {(adminRanking?.[adminRankingTab] ?? []).length === 0 ? (
                      <tr>
                        <td className="px-4 py-3 text-sm text-[#B885A3]" colSpan={6}>
                          Sem dados ainda.
                        </td>
                      </tr>
                    ) : (
                      (adminRanking?.[adminRankingTab] ?? []).map((item, index) => (
                        <tr
                          key={item.username}
                          className={`border-t border-[#F48FB122] ${adminPodiumRowClass(index)}`}
                        >
                          ...
                          <td className="px-4 py-3 text-sm text-[#A64D79]">{item.vendas}</td>
                          ...
                          <td className="px-4 py-3">
                            <div className="flex gap-1">
                              <input
                                className="w-24 rounded-lg border border-[#F8BBD0] px-2 py-1 text-xs text-[#A64D79]"
                                inputMode="decimal"
                              ...
                              <button
                                type="button"
                                className="rounded-lg border border-[#F8BBD0] px-2 py-1 text-xs text-[#A64D79] hover:bg-[#FFFFFF]"
                                onClick={() => {
          ...
          {activeSection === "membros" ? (
            <>
              <h3 className="text-2xl text-[#A64D79]">Membros</h3>
              <p className="mt-2 text-sm text-[#B885A3]">
              ...
              {!memberManageUsername ? (
                <div className="mt-4 grid gap-2 sm:grid-cols-2">
                  {membrosCards.map((member) => (
                    <div
                      ...
                      className="flex flex-wrap items-center gap-3 rounded-xl border border-[#F8BBD0AA] bg-[#FFFFFF] px-3 py-2 text-sm text-[#A64D79]"
                    >
                      {member.role !== "admin" ? (
                        <UserAvatar username={member.username} className="h-10 w-10 shrink-0" />
                      ) : (
                        <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#F8BBD0] bg-white text-xs text-[#B885A3]">
                          ADM
                        </span>
                      )}
                      <span className="min-w-0 flex-1">
                        <span className="font-medium text-[#A64D79]">@{member.username}</span> (
                      ...
                      <button
                        ...
                        className="rounded-lg bg-[#F48FB1] px-3 py-1.5 text-xs text-white hover:brightness-95"
                      >
                        Gerenciar
                      </button>
                    </div>
                ...
                <div className="mt-4 space-y-4">
                  <button
                    ...
                    className="text-sm font-medium text-[#F48FB1] underline hover:brightness-95"
                  >
                    ← Voltar para lista de membros
                  </button>

                  <div className="flex flex-wrap items-center gap-4 rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4">
                    <UserAvatar username={memberManageUsername} className="h-14 w-14 shrink-0" />
                    <div>
                      <p className="text-lg font-semibold text-[#A64D79]">@{memberManageUsername}</p>
                      <p className="text-xs text-[#B885A3]">
                  ...
                  <div className="grid gap-3 rounded-2xl border-2 border-[#F8BBD0CC] bg-gradient-to-br from-[#fff3ec] to-[#f7e2d2] p-4 shadow-sm lg:grid-cols-2">
                    <article className="rounded-xl border-2 border-[#F8BBD0CC] bg-white p-4 shadow-sm">
                      <p className="text-sm font-bold uppercase tracking-wide text-[#A64D79]">
                        Saldo da conta (em tempo real)
                      </p>
                      <p className="mt-2 text-3xl font-bold tracking-tight text-[#A64D79]">
                        R$ {memberWalletAvailable.toFixed(2)}
                      </p>
                      <p className="mt-1 text-[11px] text-[#B885A3]">
                      ...
                      <div className="mt-3 flex flex-wrap items-center gap-2">
                        <span className="text-sm font-semibold text-[#A64D79]">R$</span>
                        <input
                          className="w-36 rounded-lg border-2 border-[#F8BBD0CC] bg-[#FFFFFF] px-2 py-1.5 text-sm font-semibold text-[#A64D79]"
                          inputMode="decimal"
                          placeholder="0.00"
                        ...
                        <button
                          ...
                          className="rounded-lg bg-[#F48FB1] px-3 py-1.5 text-xs font-semibold text-white hover:brightness-95 disabled:opacity-45"
                        >
                        ...
                        <button
                          ...
                          className="rounded-lg border border-[#F8BBD0] px-2 py-1 text-xs text-[#A64D79] hover:bg-[#FFFFFF] disabled:opacity-45"
                        >
                          Cancelar
                        </button>
                      </div>
                    ...
                    <article className="rounded-xl border border-[#F8BBD0AA] bg-white p-3">
                      <p className="text-sm font-medium text-[#A64D79]">Meta, foguinho e comissao de meta</p>
                      <p className="mt-1 text-[11px] text-[#B885A3]">
                        Esta comissao entra quando a pessoa bate a meta diaria.
                      </p>
                      <div className="mt-2 grid gap-2 sm:grid-cols-3">
                        <input
                          className="rounded-lg border border-[#F8BBD0] px-2 py-1 text-xs text-[#A64D79]"
                          inputMode="decimal"
                    ...
                    <article className="rounded-xl border border-[#F8BBD0CC] bg-[#fff3ec] p-3 shadow-sm">
                      <p className="text-sm font-semibold text-[#A64D79]">Comissao GLOBAL (destaque)</p>
                      <p className="mt-1 text-[11px] text-[#B885A3]">
                        Percentual padrao da pessoa quando ainda nao bateu a meta do dia.
                      </p>
                      <div className="mt-2 flex flex-wrap items-center gap-2">
                        <input
                          className="w-44 rounded-lg border-2 border-[#F8BBD0CC] px-2 py-1 text-sm font-medium text-[#A64D79]"
                          inputMode="decimal"
                  ...
                  {memberControlMessage ? (
                    <div className="rounded-xl border border-[#F8BBD0] bg-[#FFFFFF] px-3 py-2 text-sm text-[#A64D79]">
                      {memberControlMessage}
                    </div>
                  ) : null}
                  ...
                  <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                    <article className="rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4">
                      <p className="text-xs text-[#B885A3]">Comprovantes (total)</p>
                      <p className="text-2xl font-semibold text-[#A64D79]">{managedMemberProofs.length}</p>
                    </article>
                    <article className="rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4">
                      <p className="text-xs text-[#B885A3]">Soma armazenada (total)</p>
                      <p className="text-2xl font-semibold text-[#A64D79]">
                        R$ {managedSumStored.toFixed(2)}
                      </p>
                      <p className="mt-1 text-[10px] leading-tight text-[#B885A3]">
                        Base usada no ranking (valor ja ajustado na epoca do envio).
                      </p>
                    </article>
                    <article className="rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4">
                      <p className="text-xs text-[#B885A3]">Bruto declarado (total)</p>
                      <p className="text-2xl font-semibold text-[#A64D79]">
                        R$ {managedSumGross.toFixed(2)}
                      </p>
                    </article>
                    <article className="rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4">
                      <p className="text-xs text-[#B885A3]">Valor real estimado (total)</p>
                      <p className="text-2xl font-semibold text-[#A64D79]">
                  ...
                  <article className="rounded-2xl border border-[#F8BBD0] bg-gradient-to-r from-[#FFFFFF] to-[#FCE4EC] p-4">
                    <p className="text-sm font-medium text-[#A64D79]">Ultimos 31 dias (ranking)</p>
                    <p className="mt-1 text-sm text-[#B885A3]">
                      {managed31Proofs.length} comprovante(s) — soma armazenada{" "}
                      <strong className="text-[#A64D79]">R$ {managed31SumStored.toFixed(2)}</strong>
                    </p>
                  </article>

                  <div className="overflow-hidden rounded-2xl border border-[#F8BBD0]">
                    <div className="admin-kawaii-table-scroll">
                    <table className="w-full min-w-0 border-collapse bg-white text-left text-sm">
                      <thead className="bg-[#FFFFFF]">
                        <tr>
                          <th className="px-3 py-2 text-[#A64D79]">Data</th>
                          <th className="px-3 py-2 text-[#A64D79]">Produto</th>
                          <th className="px-3 py-2 text-[#A64D79]">Armaz.</th>
                          <th className="hidden px-3 py-2 text-[#A64D79] sm:table-cell">Bruto</th>
                          <th className="px-3 py-2 text-[#A64D79]">Arquivo</th>
                          <th className="px-3 py-2 text-right text-[#A64D79]">Acao</th>
                        </tr>
                      </thead>
                      <tbody>
                        {managedMemberProofs.length === 0 ? (
                          <tr>
                            <td className="px-3 py-4 text-[#B885A3]" colSpan={6}>
                          ...
                          managedMemberProofs.map((proof) => {
                            ...
                            return (
                              <tr key={proof.id} className="border-t border-[#F48FB122] align-top">
                                <td className="px-3 py-2 text-xs text-[#B885A3]">
                                  {new Date(proof.createdAt).toLocaleString("pt-BR", {
                                    dateStyle: "short",
                                    timeStyle: "short",
                                  })}
                                </td>
                                <td className="max-w-[140px] px-3 py-2 text-[#A64D79] sm:max-w-none">
                                  {editingProofId === proof.id ? (
                                    <input
                                      className="w-full rounded-lg border border-[#F8BBD0] px-2 py-1 text-xs text-[#A64D79]"
                                ...
                                <td className="whitespace-nowrap px-3 py-2 font-medium text-[#A64D79]">
                                  {editingProofId === proof.id ? (
                                    <input
                                      className="w-24 rounded-lg border border-[#F8BBD0] px-2 py-1 text-xs text-[#A64D79]"
                                      inputMode="decimal"
                                ...
                                <td className="hidden whitespace-nowrap px-3 py-2 text-[#A64D79] sm:table-cell">
                                  R$ {gross.toFixed(2)}
                                </td>
                                <td className="px-3 py-2">
                                  <a
                                    className="text-[#F48FB1] underline"
                                    href={`/api/proofs/${proof.id}`}
                                    target="_blank"
                                    rel="noreferrer"
                                  >
                                ...
                                <td className="px-3 py-2 text-right">
                                  {editingProofId === proof.id ? (
                                    ...
                                    <button
                                      type="button"
                                      className="mb-1 rounded-lg border border-[#F8BBD0] px-2 py-1 text-xs text-[#A64D79] hover:bg-[#FFFFFF]"
                                      onClick={() => {
                                  ...
                                  {editingProofId === proof.id ? (
                                    <label className="mb-1 block text-right">
                                      <input
                                        type="file"
                                        accept="image/*,video/*"
                                        className="max-w-[180px] rounded-lg border border-[#F8BBD0] px-2 py-1 text-[10px] text-[#A64D79]"
          ...
          {activeSection === "usuarios" ? (
            <>
              <h3 className="text-2xl text-[#A64D79]">Usuarios do site</h3>
              <p className="mt-2 text-sm text-[#B885A3]">
              ...
              <form className="mt-6 grid gap-3 sm:grid-cols-2" onSubmit={handleCreateUser}>
                <input
                  className="rounded-xl border border-[#F8BBD0] bg-white px-4 py-2 text-sm text-[#A64D79] sm:col-span-2"
                  placeholder="Novo usuario (login)"
                  value={newLoginUsername}
                  onChange={(e) => setNewLoginUsername(e.target.value)}
                  required
                />
                <label className="flex items-center gap-2 text-sm text-[#A64D79] sm:col-span-2">
                  <input
                    type="checkbox"
                ...
                <button
                  type="submit"
                  className="rounded-xl bg-[#F48FB1] px-4 py-2 text-sm text-white hover:brightness-95 sm:col-span-2"
                >
                  Criar usuario
                </button>
              </form>
              ...
              <div className="mt-6 overflow-hidden rounded-2xl border border-[#F8BBD0]">
                ...
                <table className="w-full border-collapse bg-white text-left text-sm">
                  <thead className="bg-[#FFFFFF]">
                    <tr>
                      <th className="px-3 py-2 text-[#A64D79]">Foto</th>
                      <th className="px-3 py-2 text-[#A64D79]">Usuario</th>
                      <th className="min-w-[180px] px-3 py-2 text-[#A64D79]">Situacao atual</th>
                      <th className="px-3 py-2 text-[#A64D79]">Acoes</th>
                    </tr>
                  </thead>
                  <tbody>
                    {Array.from(
                      ...
                      .map((uname) => {
                        ...
                        return (
                          <tr key={uname} className="border-t border-[#F48FB122] align-top">
                            <td className="px-3 py-2">
                              <UserAvatar username={uname} className="h-9 w-9" />
                            </td>
                            <td className="px-3 py-2 font-medium text-[#A64D79]">@{uname}</td>
                            <td className="px-3 py-2">
                              <div className="flex flex-col gap-1.5">
                                ...
                                {inDb && blocked && row?.blockedReason ? (
                                  <p className="text-xs leading-snug text-[#A64D79]">
                                    <span className="text-[#B885A3]">Motivo:</span>{" "}
                                    {row.blockedReason}
                                  </p>
                                ) : null}
                                {rowBusy ? (
                                  <p className="text-xs font-medium text-[#F48FB1]">
                                    Atualizando...
                                  </p>
                                ) : null}
                              </div>
                            ...
                            <td className="px-3 py-2">
                              <div className="flex flex-wrap gap-1">
                                <button
                                  type="button"
                                  className="rounded-lg bg-[#F48FB1] px-2 py-1 text-xs text-white hover:brightness-95 disabled:cursor-not-allowed disabled:opacity-45"
                                ...
                                <button
                                  type="button"
                                  className="rounded-lg border border-[#F8BBD0] px-2 py-1 text-xs text-[#A64D79] hover:bg-[#FFFFFF] disabled:cursor-not-allowed disabled:opacity-45"
                                  disabled={rowBusy || deleted || !blocked}
                                ...
                                <button
                                  type="button"
                                  className="rounded-lg border border-[#F8BBD0] bg-white px-2 py-1 text-xs text-[#A64D79] hover:bg-[#FFFFFF] disabled:cursor-not-allowed disabled:opacity-45"
                              ...
                              {revealedPasswordByUser[uname] ? (
                                <div className="mt-2 rounded-lg border border-[#F8BBD0AA] bg-[#FFFFFF] px-2 py-1 text-xs text-[#A64D79]">
                                  <span className="text-[#B885A3]">Senha de @{uname}:</span>{" "}
                              ...
                              {blockReasonTargetUser === uname && !blocked && !deleted ? (
                                <div className="mt-2 w-full rounded-xl border border-[#F8BBD0AA] bg-[#FFFFFF] p-2">
                                  <p className="text-xs text-[#A64D79]">Motivo do bloqueio para @{uname}</p>
                                  <textarea
                                    className="mt-1 w-full rounded-lg border border-[#F8BBD0] bg-white px-2 py-1 text-xs text-[#A64D79]"
                                    rows={2}
                                  ...
                                  <div className="mt-2 flex gap-1">
                                    <button
                                      ...
                                      className="rounded-lg bg-[#F48FB1] px-2 py-1 text-xs text-white hover:brightness-95 disabled:opacity-45"
                                    >
                                      Confirmar bloqueio
                                    </button>
                                    <button
                                      ...
                                      className="rounded-lg border border-[#F8BBD0] px-2 py-1 text-xs text-[#A64D79] hover:bg-white disabled:opacity-45"
                                    >
                                      Cancelar
                                    </button>
                                  </div>
          ...
          {activeSection === "saques" ? (
            <>
              <h3 className="text-2xl text-[#A64D79]">Saques</h3>
              <p className="mt-2 text-sm text-[#B885A3]">
              ...
              <div className="mt-4 flex gap-2">
                <button
                  ...
                  className={`rounded-full px-4 py-2 text-sm ${withdrawalsTab === "pendentes" ? "border-[#F48FB1] bg-[#F48FB1] text-white" : "border-[#F8BBD0] bg-white text-[#A64D79]"}`}
                >
                  Pendentes
                </button>
                <button
                  ...
                  className={`rounded-full px-4 py-2 text-sm ${withdrawalsTab === "historico" ? "border-[#F48FB1] bg-[#F48FB1] text-white" : "border-[#F8BBD0] bg-white text-[#A64D79]"}`}
                >
                  Historico
                </button>
              </div>

              <form className="mt-5 rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4" onSubmit={handleUpdateWithdrawMin}>
                <p className="text-sm font-medium text-[#A64D79]">Minimo de saque</p>
                <div className="mt-2 flex flex-wrap items-center gap-2">
                  <input
                    className="w-40 rounded-xl border border-[#F8BBD0] bg-white px-3 py-2 text-sm text-[#A64D79]"
                    inputMode="decimal"
                  ...
                  <button
                    type="submit"
                    className="rounded-xl bg-[#F48FB1] px-3 py-2 text-xs text-white hover:brightness-95"
                  >
                    Salvar minimo
                  </button>
                </div>
              ...
              {withdrawalsMessage ? (
                <p className="mt-3 text-sm text-[#A64D79]">{withdrawalsMessage}</p>
              ) : null}

              <div className="mt-5 overflow-hidden rounded-2xl border border-[#F8BBD0]">
                <div className="admin-kawaii-table-scroll">
                <table className="w-full border-collapse bg-white text-left text-sm">
                  <thead className="bg-[#FFFFFF]">
                    <tr>
                      <th className="px-3 py-2 text-[#A64D79]">Usuario</th>
                      <th className="px-3 py-2 text-[#A64D79]">Valor</th>
                      <th className="px-3 py-2 text-[#A64D79]">Status</th>
                      <th className="px-3 py-2 text-[#A64D79]">Data</th>
                      <th className="px-3 py-2 text-[#A64D79]">Acao</th>
                    </tr>
                  </thead>
                  <tbody>
                    {visibleWithdrawals.length === 0 ? (
                      <tr>
                        <td className="px-3 py-4 text-[#B885A3]" colSpan={5}>
                          {withdrawalsTab === "pendentes"
                      ...
                      visibleWithdrawals.map((item) => {
                        ...
                        return (
                          <tr key={item.id} className="border-t border-[#F48FB122] align-top">
                            <td className="px-3 py-2 font-medium text-[#A64D79]">@{item.username}</td>
                            <td className="px-3 py-2 text-[#A64D79]">R$ {Number(item.amount ?? 0).toFixed(2)}</td>
                            <td className="px-3 py-2 text-[#A64D79]">
                              ...
                              {item.status === "rejected" && item.rejectionReason ? (
                                <p className="mt-1 text-xs text-[#B885A3]">Motivo: {item.rejectionReason}</p>
                              ) : null}
                            </td>
                            <td className="px-3 py-2 text-xs text-[#B885A3]">
          ...
          {activeSection === "indicacoes" ? (
            <>
              <h3 className="text-2xl text-[#A64D79]">Indicacoes</h3>
              <p className="mt-2 text-sm text-[#B885A3]">
              ...
              <form
                className="mt-5 rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4"
              ...
              >
                ...
                <div className="mt-3 flex flex-wrap items-center gap-2">
                  <input
                    className="w-32 rounded-xl border border-[#F8BBD0] bg-white px-3 py-2 text-sm text-[#A64D79]"
                    inputMode="decimal"
                  ...
                  <button
                    ...
                    className="rounded-xl bg-[#F48FB1] px-3 py-2 text-xs text-white hover:brightness-95 disabled:opacity-60"
                  >
                ...
                {referralsAdminMessage ? (
                  <p className="mt-3 text-sm text-[#A64D79]">{referralsAdminMessage}</p>
                ) : null}
              </form>

              <div className="mt-5 grid gap-3 sm:grid-cols-3">
                <article className="rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4">
                  <p className="text-sm text-[#B885A3]">Total de vinculos</p>
                  <p className="text-2xl text-[#A64D79]">
                    {referralsAdminData?.links.length ?? 0}
                  </p>
                </article>
                <article className="rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4">
                  <p className="text-sm text-[#B885A3]">Anfitrioes (quem indicou)</p>
                  <p className="text-2xl text-[#A64D79]">
                    {referralsAdminData?.groupedByInviter.length ?? 0}
                  </p>
                </article>
                <article className="rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4">
                  <p className="text-sm text-[#B885A3]">Bonus total acumulado</p>
                  <p className="text-2xl text-[#A64D79]">
                    R${" "}
              ...
              <div className="mt-5 grid gap-3">
                <h4 className="text-base font-medium text-[#A64D79]">
                  Quem indicou quem
                </h4>
                {(referralsAdminData?.groupedByInviter ?? []).length === 0 ? (
                  <p className="text-sm text-[#B885A3]">
                    ...
                    >
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        ...
                        <div className="text-right">
                          <p className="text-xs text-[#B885A3]">Bonus acumulado</p>
                          <p className="text-base font-semibold text-[#A64D79]">
                      ...
                      <div className="mt-3 grid gap-2">
                        {group.invitees.map((invitee) => (
                          <div
                            ...
                            className="flex flex-wrap items-center justify-between gap-2 rounded-xl border border-[#F8BBD0AA] bg-white px-3 py-2"
                          >
                            ...
                            <div className="text-right">
                              ...
                              <p className="text-xs font-medium text-[#A64D79]">
          ...
          {activeSection === "configuracoes" ? (
            <>
              <h3 className="text-2xl text-[#A64D79]">Configuracoes</h3>
              <div className="mt-4 rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4">
                <p className="text-sm text-[#B885A3]">
          ...
          {activeSection === "gerenciar-multas" ? (
            <>
              <h3 className="text-2xl text-[#A64D79]">Gerenciar Multas</h3>
              <p className="mt-2 text-sm text-[#B885A3]">
              ...
              <div className="mt-4 flex gap-2">
                <button
                  ...
                  className={`rounded-full px-3 py-1.5 text-xs ${fineAdminTab === "aplicar" ? "border-[#F48FB1] bg-[#F48FB1] text-white" : "border-[#F8BBD0] bg-white text-[#A64D79]"}`}
                >
                  Aplicar
                </button>
                <button
                  ...
                  className={`rounded-full px-3 py-1.5 text-xs ${fineAdminTab === "multas" ? "border-[#F48FB1] bg-[#F48FB1] text-white" : "border-[#F8BBD0] bg-white text-[#A64D79]"}`}
                >
                  Multas
                </button>
              </div>
              ...
              <form className="mt-6 grid gap-3" onSubmit={handleApplyFine}>
                ...
                <label className="grid gap-1 text-sm text-[#A64D79]">
                  ...
                  <span className="text-xs font-normal leading-relaxed text-[#B885A3]">
                    Este campo e sempre em <strong className="text-[#A64D79]">porcentagem (%)</strong>
                    . Digite <strong className="text-[#A64D79]">0</strong> quando nao quiser desconto
                    por % (multa so por tempo/motivo). Ex.: <strong className="text-[#A64D79]">10</strong>{" "}
                    = reduz 10% do valor real dela enquanto a multa estiver valendo.
                  </span>
                  <input
                    className="mt-1 rounded-xl border border-[#F8BBD0] bg-white px-4 py-2 text-sm text-[#A64D79]"
                    inputMode="decimal"
                ...
                {fineMessage ? <p className="text-sm text-[#A64D79]">{fineMessage}</p> : null}
              </form>
              ) : null}

              <div className="mt-4 grid gap-3">
                {fines.map((fine) => (
                  <article key={fine.id} className="rounded-2xl border border-[#F8BBD0] bg-[#FFFFFF] p-4">
                    <p className="text-sm text-[#A64D79]">Usuario: {fine.username}</p>
                    <p className="text-sm text-[#A64D79]">Motivo: {fine.reason}</p>
                    <div className="mt-2 grid gap-2 sm:grid-cols-3">
                      <select
                        className="rounded-lg border border-[#F8BBD0] bg-white px-2 py-1 text-xs text-[#A64D79]"
                    ...
                    <div className="mt-2 flex gap-1">
                      <button
                        ...
                        className="rounded-lg border border-[#F8BBD0] px-3 py-1 text-xs text-[#A64D79] hover:bg-white"
                      >
                        Salvar edicao
                      </button>
                      <button
                        onClick={() => handleRemoveFine(fine.id, fine.username)}
                        className="rounded-lg bg-[#F48FB1] px-3 py-1 text-xs text-white hover:brightness-95"
                      >
                        Remover multa
                      </button>
                    </div>
            ...
            <>
              ...
              {hotsTab === "liberar" ? (
                <div className="mt-6 grid gap-4">
                  <div>
                    <p className="mb-2 text-sm font-medium text-[#A64D79]">Quem recebe o acesso</p>
